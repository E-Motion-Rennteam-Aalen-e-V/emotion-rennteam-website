...
/* eslint-disable react-hooks/refs, react-hooks/set-state-in-effect --
   Vendored as-is from the mapcn registry (https://mapcn.dev/r/map.json);
   these are safe, established imperative-escape-hatch patterns for
   wrapping the non-React MapLibre GL instance, flagged only by the new
   React Compiler lint rules. Keep in sync with upstream rather than
   hand-editing. */
